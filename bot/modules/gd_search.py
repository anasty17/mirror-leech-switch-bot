...
async def select_type(ctx):
    ...
    if user_id != int(data[1]):
        await ctx.event.answer(text="Not Yours!", show_alert=True)
        return
    elif data[2] == 'rec':
...
bot.add_handler(CommandHandler(BotCommands.ListCommand, gdrive_search, filter=CustomFilters.authorized))
