...
bot.add_handler(CommandHandler(BotCommands.AuthorizeCommand,
                authorize, filter=CustomFilters.sudo))
bot.add_handler(CommandHandler(BotCommands.UnAuthorizeCommand,
                unauthorize, filter=CustomFilters.sudo))
bot.add_handler(CommandHandler(BotCommands.AddSudoCommand,
                addSudo, filter=CustomFilters.sudo))
bot.add_handler(CommandHandler(BotCommands.RmSudoCommand,
                removeSudo, filter=CustomFilters.sudo))
