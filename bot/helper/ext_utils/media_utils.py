...
from bot import LOGGER, subprocess_lock, MAX_SPLIT_SIZE
        ...
        while i <= parts or start_time < duration - 4:
            ...
            if code == -9:
                ...
                if multi_streams:
                    ...
                    LOGGER.warning(
                        f"{stderr}. Unable to split this video, if it's size less than {MAX_SPLIT_SIZE} will be uploaded as it is. Path: {path}"
                    )
                return False
